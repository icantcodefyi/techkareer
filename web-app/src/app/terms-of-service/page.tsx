export default function TermsOfService() {
  ...
  return (
    <div className="m-auto w-9/12 p-20 text-justify">
      ...
      <p>
        By accessing this Website, accessible from TechKareer.com, you are
      ...
      <p>
        ...
        on TechKareer&apos;s Website for personal, non-commercial transitory
      ...
      <p>
        This will let TechKareer to terminate upon violations of any of these
      ...
      <p>
        All the materials on TechKareer’s Website are provided &#34;as is&#34;.
        TechKareer makes no warranties, may it be expressed or implied,
        therefore negates all other warranties. Furthermore, TechKareer does not
      ...
      <p>
        TechKareer or its suppliers will not be hold accountable for any damages
        that will arise with the use or inability to use the materials on
        TechKareer’s Website, even if TechKareer or an authorize representative
      ...
      <p>
        The materials appearing on TechKareer’s Website may include technical,
        typographical, or photographic errors. TechKareer will not promise that
        any of the materials in this Website are accurate, complete, or current.
        TechKareer may change the materials contained on its Website at any time
        without notice. TechKareer does not make any commitment to update the
        materials.
      </p>
      ...
      <p>
        TechKareer has not reviewed all of the sites linked to its Website and
        is not responsible for the contents of any such linked site. The
        presence of any link does not imply endorsement by TechKareer of the
      ...
      <p>
        TechKareer may revise these Terms of Use for its Website at any time
      ...
      <p>
        Any claim related to TechKareer&apos;s Website shall be governed by the
